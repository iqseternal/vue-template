...
import { type PropType, computed, ref, watch, nextTick, inject } from "vue"
...
const showScreenfull = computed(() => {
  return settingsStore.showScreenfull.value;
})
...
<template>
  <div class="scroll-container">
    <ElIcon class="arrow left" @click="scrollTo('left')">
      <ArrowLeft />
    </ElIcon>
    ...
    <ElIcon class="arrow right" @click="scrollTo('right')">
      <ArrowRight />
    </ElIcon>
