...
<template>
  <div v-if="!props.item.meta?.hidden" :class="{ 'simple-mode': props.isCollapse, 'first-level': props.isFirstLevel }">
    <template v-if="!alwaysShowRootMenu && theOnlyOneChild && !theOnlyOneChild.children">
      <SidebarItemLink v-if="theOnlyOneChild.meta" :to="resolvePath(theOnlyOneChild.path)">
        <ElMenuItem :index="resolvePath(theOnlyOneChild.path)">
          ...
          <component v-else-if="theOnlyOneChild.meta.elIcon" :is="(theOnlyOneChild.meta.elIcon as any)" class="el-icon"></component>
    ...
    <ElSubMenu v-else :index="resolvePath(props.item.path)" teleported>
      <template #title>
        <svg-icon v-if="props.item.meta && props.item.meta.svgIcon" :name="props.item.meta.svgIcon" />
        <component v-else-if="props.item.meta && props.item.meta.elIcon" :is="(props.item.meta.elIcon as any)" class="el-icon" />
